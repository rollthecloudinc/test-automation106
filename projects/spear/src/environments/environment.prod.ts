...
export const environment = {
  ...
  apiGatewaySettings: {
    endpointUrl: 'https://edge.hedge.earth/emissionless/rollthecloudinc/test-automation106-objects-prod/shapeshifter',
  },
  mediaSettings: {
    ...
    imageUrl: 'https://edge.hedge.earth/emissionless/test-automation106',
  ...
  panelsSettings: {
    ...
    objectsRootUrl: 'https://rollthecloudinc.github.io/test-automation106-objects-prod'
  },
  alienaliasSettings: {
    openSearchDomain: 'search-classifieds-ui-prod-o5unofrr3c4qb3ykfrxebh2e4a'
  },
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://test-automation106.druidcloud.io/auth-callback',
    silent_redirect_uri: 'https://test-automation106.druidcloud.io/silent-refresh.html',
    response_type: "code",
